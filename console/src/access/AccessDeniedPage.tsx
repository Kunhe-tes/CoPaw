...
import type { ConsoleAccessDecision } from "./consoleAccess";
...
export default function AccessDeniedPage({ decision }: AccessDeniedPageProps) {
  return (
    <main className={styles.page}>
      <section className={styles.content} aria-labelledby="access-denied-title">
        ...
        {decision.userId && (
          <p className={styles.identity}>当前用户：{decision.userId}</p>
        )}
      </section>
    </main>
  );
