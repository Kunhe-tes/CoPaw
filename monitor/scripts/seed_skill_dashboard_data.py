...
CLICK_EVENT_INDEXES = {
    ...
    "idx_source_root_event_clicked": "CREATE INDEX idx_source_root_event_clicked ON swe_html_preview_click_events (source_id, root_template_id, root_result_id, event_type, clicked_at)",
