...
The Management Console design system SHALL use a neutral light blue-gray palette centered on `#3769FC` and SHALL treat embedded presentation as its current color target.

#### Scenario: A migrated management surface renders

- **WHEN** a management surface covered by the design system is displayed
- **THEN** it SHALL use the documented blue-gray canvas, white surface, blue-gray border/text hierarchy, and blue primary-action roles without warm cream or coral theme roles
