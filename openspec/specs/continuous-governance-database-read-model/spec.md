# continuous-governance-database-read-model Specification

## Purpose
TBD - created by archiving change continuous-governance-database-read-model. Update Purpose after archive.
## Requirements
